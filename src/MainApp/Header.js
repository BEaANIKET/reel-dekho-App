...
import { View, Text, Pressable, Image, Modal, ScrollView, Animated, Easing, TouchableWithoutFeedback } from "react-native";
...
const Header = ({ navigation }) => {
  ...
  return (
    ...
    >
      ...
      <Image
        source={{
          uri: "https://gdlplay.in/public/Images/c4caab4b9e487b7afe9b38e894ee7ea8",
        }}
        ...
        <TouchableWithoutFeedback onPress={toggleMenu}>
          <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.5)" }}>
            ...
            >
              ...
              <ScrollView>
                {[{ name: "Home", icon: "home" }, { name: "Change Password", icon: "key" }, { name: "Logout", icon: "sign-out" }, { name: "Saved", icon: "bookmark" }, { name: "FAQ", icon: "question-circle" }, { name: "Delete Account", icon: "trash" }].map((item, index) => (
                  <Pressable
                    key={index}
                    style={{
                      flexDirection: "row",
                    ...
                    onPress={() => {
                      if (item.name === "FAQ") navigation.navigate("Faq");
                      if (item.name === "Saved") navigation.navigate("Saved");
                    }}
                  >
